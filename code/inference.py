...
def parse_args():
    ...
    # Conventional args
    parser.add_argument('--data_dir', default=os.environ.get('SM_CHANNEL_EVAL', '/data/ephemeral/home/data/medical'))
    parser.add_argument('--model_dir', default=os.environ.get('SM_CHANNEL_MODEL', '/data/ephemeral/trained_models'))
